$(function () {
  ...
  function newObj(quizName, answerName) {
    this.queizName = { questions: quizName };
    this.answerName = { questions: answerName };
  }
  var checklist = [];
  ...
  $(document).on('change', '.quiz__input-checkbox', function () {
    ...
    if (this.checked) {
      checklist = appendObjTo({ question: html, answer: val });
